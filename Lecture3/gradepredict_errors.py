...
def test():
  ...
  #TEST 3: Test project score calculation
  project_scores1 = [200, 200, 200]
  expected_output1 = 200 + 200 + 200

  if calculate_project_score(project_scores1) == expected_output1:
      print('TEST 3.1 passed')
  else:
      print('TEST 3.1 failed')

  project_scores2 = [160, 130, 170]
  expected_output2 = 160 + 130 + 170

  if calculate_project_score(project_scores2) == expected_output2:
       print('TEST 3.2 passed')
  else:
       print('TEST 3.2 failed')

  #TEST 4: Test midterm score calculations
  midterm_scores1 = [100, 100]
  expected_output1_mid = 100 + 100

  if calculate_midterm_score(midterm_scores1) == expected_output1_mid:
      print('TEST 4.1 passed')
  else:
      print('TEST 4.1 failed')

  midterm_scores2 = [80, 55]
  expected_output2_mid = 80 + 55

  if calculate_midterm_score(midterm_scores2) == expected_output2_mid:
